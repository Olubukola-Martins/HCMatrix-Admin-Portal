    ...
    <PageLayout
      ...
      <div className="flex flex-col gap-8 ">
        ...
        <div className="inline-grid grid-cols-4 gap-12">
          ...
          <UserMetricDBAccountInfoCard amount={0} icon={{ icon: "mi:options-vertical", color: "black" }} indicator={{ indicatorRating: 0.4, indicatorText: "Vs preceeding month" }} title="Deactivated Accounts" />
